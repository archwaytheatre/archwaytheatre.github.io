  ...
  [:div.content
   ...
   [:div
    [:ul
     ...
     [:li "The Archway Theatre Company will not be liable (to the fullest extent permitted at law) for any loss,"
      " damage or inconvenience arising as a consequence of any use of or the inability to use any information on this site."]
     [:li "The Archway Theatre Company takes no responsibility for the contents of linked websites and links should"
      " not be taken as endorsement of any kind."
      "We have no control over the availability of the linked pages"]
     [:li "No material from this Website may be copied, modified, republished, posted, transmitted, or distributed in"
      " any way, without the prior written permission of The Archway Theatre Company."]
     [:li "For further information about this site please reach out to us via our "
